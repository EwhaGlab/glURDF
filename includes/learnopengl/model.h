...
const glm::vec3 blue = glm::vec3(0.0, 0.0, 0.8);
...
public:
    ...
    void setColor(string material)
    {
        if (material == "Blue")
            ...
            this->color = grey;
        else if (material == "LightGrey")
            this->color = lightGrey;
        else if (material == "DarkGrey")
            this->color = darkGrey;
        else if (material == "Red")
            this->color = red;
        else if (material == "White")
            this->color = white;
        else if (material == "Orange")
            this->color = orange;
        else if (material == "Brown")
            this->color = brown;
        else
            this->color = black;
    }
